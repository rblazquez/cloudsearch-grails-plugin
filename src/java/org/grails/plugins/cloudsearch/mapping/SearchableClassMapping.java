...
import org.grails.plugins.cloudsearch.mapping.SearchableClassPropertyMapping;
...
public class SearchableClassMapping {
	...
	public SearchableClassMapping(GrailsDomainClass domainClass,
	 ...
	 * 
	 * @param contextHolder
	 *            context holding all known searchable mappings.
	 */
	public void validate(CloudSearchContextHolder contextHolder) {
		for (SearchableClassPropertyMapping scpm : propertiesMapping) {
