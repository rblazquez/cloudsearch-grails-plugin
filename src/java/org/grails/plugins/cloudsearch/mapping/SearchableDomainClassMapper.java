...
class SearchableDomainClassMapper extends GroovyObjectSupport {
     ...
     * @param csConfig          ElasticSearch configuration
     */
    SearchableDomainClassMapper(GrailsApplication grailsApplication, GrailsDomainClass domainClass, ConfigObject csConfig) {
    ...
    public void buildDefaultMapping(GrailsDomainClass grailsDomainClass) {
        ...
        for (GrailsDomainClassProperty property : grailsDomainClass.getPersistentProperties()) {
            ...
            List<String> defaultExcludedProperties = (List<String>) csConfig.get("defaultExcludedProperties");
    ...
    private void buildMappingFromOnlyExcept(GrailsDomainClass domainClass, Set<String> inheritedProperties) {
        ...
        Boolean alwaysInheritProperties = (Boolean) csConfig.get("alwaysInheritProperties");
